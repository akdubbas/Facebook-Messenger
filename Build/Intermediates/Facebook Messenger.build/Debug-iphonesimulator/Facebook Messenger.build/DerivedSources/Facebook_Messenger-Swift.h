...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Facebook_Messenger",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18Facebook_Messenger11AppDelegate")
...
SWIFT_CLASS("_TtC18Facebook_Messenger15ChatMessageCell")
...
- (void)showChatLogControllerWithUser:(User * _Nonnull)user;
- (void)handleLogout;
