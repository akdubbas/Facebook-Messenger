...
class LoginViewController: UIViewController, UITextFieldDelegate {
    ...
    lazy var profileImageView: UIImageView = {
        ...
        imageView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(displayActionSheet)))
    ...
    @objc func displayActionSheet()
    {
        ...
        let choosePictureAction: UIAlertAction = UIAlertAction(title: "Choose from library", style: .default) { action -> Void in
            self.handleSelectProfilePicture()
        ...
        let deleteProfilePicture : UIAlertAction = UIAlertAction(title: "Delete", style: .destructive) { (action) -> Void in
            self.profileImageView.image = UIImage(named:"profile_pic")
        }
        
        actionSheetController.addAction(cameraAction)
        actionSheetController.addAction(choosePictureAction)
        actionSheetController.addAction(deleteProfilePicture)
